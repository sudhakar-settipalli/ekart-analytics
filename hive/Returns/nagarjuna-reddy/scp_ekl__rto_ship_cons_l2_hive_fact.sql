INSERT OVERWRITE TABLE rto_ship_cons_l2_hive_fact
...
from bigfoot_external_neo.scp_ekl__rto_ship_l1_hive_fact A
left join bigfoot_external_neo.scp_ekl__rto_cons_l1_hive_fact B
